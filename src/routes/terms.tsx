    ...
    <div className="min-h-dvh bg-background">
      ...
      <main className="safe-x mx-auto max-w-3xl space-y-8 px-4 py-8 sm:py-12">
        <div className="space-y-2">
          <h1 className="text-2xl font-bold sm:text-3xl">Termos de uso e condições comerciais</h1>
          <p className="text-sm text-muted-foreground">
            Versão {TERMS_VERSION} · atualizado em {TERMS_LAST_UPDATED}
          </p>
        </div>

        {/* Aviso no topo, e não no rodapé: quem precisa saber que o documento
            está incompleto precisa saber antes de ler, não depois. */}
        <div className="flex gap-3 rounded-lg border border-amber-500/40 bg-amber-500/10 p-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <ul className="list-inside list-disc text-muted-foreground">
              {PENDING_LEGAL_SECTIONS.map((section) => (
        ...
        <Section id="planos" title="2. Planos e preços">
          <p>
          ...
          <div className="space-y-3 rounded-lg border border-border p-4">
            <div>
              ...
              <p>
                Mensalidade fixa de <strong>{formatCents(premium.monthlyFeeCents)}</strong>, sem
                taxa de cadastro e sem cobrança por pedido. Inclui todos os recursos da plataforma,
                entre eles {restricted}.
              </p>
            </div>
            ...
            <div className="border-t border-border pt-3">
              ...
              <p>
                Taxa única de cadastro de <strong>{formatCents(cents.setupFeeCents)}</strong>,
                cobrada uma só vez na primeira fatura, somada à cobrança por pedido válido. Não
                inclui {restricted}.
              </p>
            </div>
          </div>
        ...
        <Section id="pedido-valido" title="3. O que é um pedido válido">
          <p>
            No plano {cents.name}, a cobrança incide sobre pedidos válidos. É considerado válido o
            pedido que entra no fluxo operacional do estabelecimento — ou seja, a partir do momento
            em que é aceito e passa para preparo.
          </p>
        ...
        <Section id="promocao" title="4. Redução por volume no plano CENTS">
          <p>
            Ao atingir <strong>{cents.promotionThresholdOrders} pedidos válidos</strong> em um
            ciclo, o <strong>ciclo seguinte</strong> passa a ser cobrado a{" "}
            <strong>{formatCents(cents.promotionalOrderUnitPriceCents)}</strong> por pedido, no
            lugar de {formatCents(cents.defaultOrderUnitPriceCents)}.
          </p>
          <p>
          ...
          <p>
            ...
            terminar abaixo de {cents.promotionThresholdOrders} pedidos válidos, esse ciclo é
            cobrado pelo valor que já estava vigente, e o ciclo seguinte retorna a{" "}
            {formatCents(cents.defaultOrderUnitPriceCents)} por pedido.
          </p>
        </Section>

        <Section id="ciclo" title="5. Ciclo de cobrança">
          <p>
          ...
          <p>
            A fatura é emitida no fechamento do ciclo, com base nos pedidos efetivamente
            registrados. Os valores exibidos durante o ciclo em andamento são estimativas e podem
            variar até o fechamento.
          </p>
        </Section>

        <Section id="ativacao" title="6. Ativação e pagamento">
          <p>
            A conta criada permanece com a assinatura pendente até a confirmação do pagamento. A
            cobrança automática por PIX está em implantação; até a sua disponibilização, a ativação
            é realizada pela equipe da FlyControl após a confirmação do pagamento.
          </p>
          <p>
        ...
        <Section id="mudanca-de-plano" title="7. Mudança de plano">
          <p>
            A mudança de plano passa a valer no ciclo seguinte, sem cálculo proporcional sobre o
            ciclo em andamento.
          </p>
          <p>
        ...
        <Section id="suspensao" title="8. Suspensão do acesso">
          <p>
        ...
        <Section id="dados" title="9. Dados do estabelecimento">
          <p>
          ...
          <p className="rounded-md border border-dashed border-border p-3">
            As disposições completas sobre tratamento de dados pessoais, base legal, retenção,
            compartilhamento e direitos do titular serão publicadas na Política de Privacidade, em
            elaboração.
          </p>
        </Section>

        <Section id="alteracoes" title="10. Alterações destes termos">
          <p>
            Alterações materiais nestes termos geram uma nova versão do documento. A versão vigente
            no momento do aceite fica registrada junto ao cadastro do estabelecimento.
          </p>
        </Section>
