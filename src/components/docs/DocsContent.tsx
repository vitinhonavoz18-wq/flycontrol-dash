 ...
 *
 * Fica num componente separado porque aparece em dois lugares: na aba
 * "Documentação" dentro de Configurações e na página /docs, que continua
 * acessível para uma loja suspensa (é a única tela que ela enxerga).
 */
export function DocsContent() {
  return (
    <div className="max-w-4xl space-y-8">
      <div>
        <h2 className="text-2xl font-bold tracking-tight">Como o FlyControl funciona</h2>
