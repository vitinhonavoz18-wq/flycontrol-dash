          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            {cta && (
              <button
                ...
                className="min-h-11 flex-1 rounded-xl bg-primary px-4 text-sm font-bold text-primary-foreground transition-transform active:scale-[0.98] sm:flex-none"
              >
                {cta.rotulo}
              </button>
            )}
            {acaoSecundaria && (
              <button
                ...
                className="min-h-11 rounded-xl px-3 text-sm font-semibold text-muted-foreground underline-offset-4 hover:text-foreground hover:underline"
              >
